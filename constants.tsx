...
export const CLOUD_SERVICES: CloudService[] = [
  ...
  { id: 'baidu', name: 'Baidu Cloud', icon: 'https://img.icons8.com/color/96/baidu.png', category: 'public', description: 'Intelligent cloud services' },
  { id: 'gcp', name: 'GCP', icon: 'https://img.icons8.com/color/96/google-cloud.png', category: 'public', description: 'Google Cloud Platform' },
  { id: 'm365', name: 'M365', icon: 'https://img.icons8.com/color/96/microsoft-365.png', category: 'software', description: 'Office productivity suite' },
  { id: 'wps', name: 'WPS', icon: 'https://img.icons8.com/color/96/wps-office.png', category: 'software', description: 'Leading office tools' },
...
export const PRODUCT_PILLARS: ProductHighlight[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&q=80&w=800", // Abstract contrast of shapes and colors
    isImageLeft: false
  }
];
...
export const CASES: CaseStudy[] = [
  ...
  },
  {
    ...
    stats: '创意产出量提升 5 倍',
    description: '设计总监指挥多组 AI 团队进行草图深化与配色实验。通过“项目/文件”中心模式，所有历史改稿记录与配色逻辑均可溯源，大幅降低了团队沟通的磨合成本。',
