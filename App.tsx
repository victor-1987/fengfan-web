      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow pt-16">
          <Routes>
            ...
            <Route path="/supermagic" element={<SuperMagicPage onBookDemo={openDemoModal} />} />
            <Route path="/ai-agent" element={<AIAgentPage onBookDemo={openDemoModal} />} />
            <Route path="/ai-foundry" element={<AIFoundryPage onBookDemo={openDemoModal} />} />
